...
const rawHotels = [
  ...
  { destinationSlug: "bishnupur", destinationName: "Bankura", name: "Bankura Heritage Resort", description: "Experience the magic of terracotta architecture and Bankura horse handicrafts in this authentic rural Bengal retreat.", starRating: 4, pricePerNight: 3800, amenities: ["WiFi", "Restaurant", "Garden", "Cultural Programs", "Parking"], address: "Temple Road, Bishnupur, Bankura", state: "West Bengal", rating: 4.4, reviewCount: 156, freeCancellation: true },
