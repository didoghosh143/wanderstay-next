...
function HotelCard({ hotel }: { hotel: any }) {
  ...
  return (
    <motion.div
      ...
      className="group relative rounded-[2rem] overflow-hidden cursor-pointer shadow-xl shadow-black/5 hover:shadow-2xl hover:shadow-orange-900/10 h-[440px] transition-all border border-white/50 bg-slate-50"
        ...
        <div className="relative z-10">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-1.5 text-orange-600 text-[11px] font-bold tracking-[0.15em] uppercase">
              ...
              <span>{hotel.destinationName || "Location"}</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1 text-gray-600 text-[11px] font-medium mb-3">
            <MapPin size={11} className="text-gray-400" />
            <span className="truncate">{hotel.address?.slice(0, 45)}...</span>
          </div>
