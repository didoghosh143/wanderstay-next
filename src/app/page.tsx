...
function DestCard({ dest, index }: { dest: any; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="group bg-white rounded-3xl overflow-hidden cursor-pointer shadow-md shadow-black/5 hover:shadow-xl border border-gray-100 flex-shrink-0 snap-center w-[85vw] md:w-[350px] flex flex-col"
    ...
    >
      ...
      <div className="p-6 bg-white flex-1 flex flex-col">
        ...
        <div className="flex items-end justify-between mb-4">
          ...
          <span className="text-gray-500 text-xs font-medium mb-1">{dest.properties || 42} hotels</span>
        </div>
